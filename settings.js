...
module.exports = {
SESSION_ID: process.env.SESSION_ID || XUYAhJRD#BPX_O5PdkKyzenhuXFc7AA3e3-_Y6yxeevhv6aAnhz0, // 
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94774135264",
DEV: process.env.DEV || "94774135264",
